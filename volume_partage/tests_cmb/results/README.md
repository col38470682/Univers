...
| **Résultat du contrôle** | Forte concentration des observations dans un seul quadrant | Le signal devient compatible avec l'hypothèse nulle Permutation par blocs spatiaux :
r = −0.0237
p = 0.671 |
